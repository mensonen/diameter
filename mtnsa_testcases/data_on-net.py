...
def main():
    ...
    print("1. Register and attach SIM on Home Network")
    print("2. Establish data session")
    print("3. Generate data usage")
    print("4. Send Gy updates during session")
    print("5. Terminate session")
    print("6. Verify charging")
    print("7. Fetch Kinesis events")
    print()
