...
# SCENARIO CONFIG
# ============================================================
SCENARIO_KEY = "mt_voice_roaming_same_country"
CFG = {
    "scenario_name": "MT VOICE ROAMING - CALLED IN ROAMING COUNTRY; SOURCE SIM IN SAME ROAMING COUNTRY",
    "description": "Called in Roaming Country; Source SIM in Same Roaming Country",
    "session_suffix": "mt-voice-roaming-same-country",
    ...
    "calling_party_address": "447700900111",
...
def validate_voice_kinesis_events(events):
    ...
    print(f"Expected charging dimension : {CFG['expected_charging_dimension']}")
...
def main():
    ...
    try:
        ...
        with socket.create_connection((connect_host, SERVER_PORT), timeout=10) as sock:
            ...
            print("Precondition only - called subscriber is attached in visited network")

            print("\n2. Trigger MT call from roaming country to same roaming country")
