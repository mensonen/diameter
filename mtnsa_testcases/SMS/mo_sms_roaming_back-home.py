...
# SCENARIO SELECTION
# ============================================================
SCENARIO_KEY = "mo_sms_back_home_roaming_country"

TEST_SCENARIOS = {
    "mo_sms_back_home_roaming_country": {
        "scenario_name": "MO SMS BACK HOME - SIM IN ROAMING COUNTRY - DESTINATION IN HOME COUNTRY",
        "description": "SIM in Roaming Country; destination in Home Country",
        "session_suffix": "sms-back-home-roaming-country",
        ...
        "type": "Roaming",
        "b_party_msisdn": "276512345678",   # Replace with actual home-country destination
        "traffic_case": 20,
        ...
        "ims_number_portability_routing_info": "D083",  # Replace if your routing map differs

        "enable_tgpp_mcc_mnc_avps": True,
        "tgpp_imsi_mcc_mnc": "40410",       # Source roaming MCCMNC
        "tgpp_ggsn_mcc_mnc": "65512",       # Destination home-country MCCMNC
        "tgpp_sgsn_mcc_mnc": "40410",       # Serving roaming network MCCMNC

        "expected_source_mccmnc": "40410",
    },
}
...
def validate_back_home_roaming(events):
    print_banner("VERIFY BACK HOME ROAMING SMS")
...
def main():
    ...
    try:
        with socket.create_connection((SERVER_FQDN, SERVER_PORT), timeout=10) as sock:
            ...
            print("Precondition only - scenario assumes subscriber is attached in roaming country")

            print("\nSTEP 2: Send SMS to home-country number")
        ...
        validate_back_home_roaming(events)
