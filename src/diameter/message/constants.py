...
APP_RIVADA_XF = 16777333
APP_RIVADA_XP = 16777334
...
APP_S6B_APPLICATION_ONE_AAA_ = 16777999
...
APP_ERICSSON_DIAMETER_SIGNALLING_CONTROLLER_APPLICATION_DSC_ = 16777315
APP_ERICSSON_SX = 16777327
APP_DIAMETER_MOBILE_IPV6_IKE_MIP6I_ = 7
APP_DIAMETER_MOBILE_IPV6_AUTH_MIP6A_ = 8
APP_VODAFONE_GX_ = 16777234
APP_ALU_SY = 111
...
APP_NSN_UNIFIED_CHARGING_TRIGGER_FUNCTION_UCTF_ = 16777246
...
VENDOR_ALU = 637
VENDOR_NOKIA = 94
VENDOR_NOKIASOLUTIONSANDNETWORKS = 28458
VENDOR_HP = 11
...
VENDOR_TELEFONICA_MOVILES_ESPA_S_A_ = 27640
...
E_FRAMED_ROUTING_SEND_AND_LISTEN_ = 3
AVP_FILTER_ID = 11
AVP_FRAMED_MTU = 12
...
E_LOGIN_SERVICE_TCP_CLEAR_QUIET_SUPPRESSES_ANY_NAS_GENERATED_CONNECT_STRING_ = 8
...
E_ERROR_CAUSE_INVALID_EAP_PACKET_IGNORED_ = 202
...
E_ERROR_CAUSE_REQUEST_NOT_ROUTABLE_PROXY_ = 502
...
E_RESULT_CODE_DIAMETER_END_USER_SERVICE_DENIED = 4241
...
E_FRAGMENTATION_FLAG_DON_T_FRAGMENT_DF_ = 0
E_FRAGMENTATION_FLAG_MORE_FRAGMENTS_MF_ = 1
AVP_IP_OPTION = 537
...
E_IP_OPTION_TYPE_UPSTREAM_MULTICAST_PKT_ = 152
...
E_TCP_OPTION_TYPE_TCP_AUTHENTICATION_OPTION_TCP_AO_ = 29
E_TCP_OPTION_TYPE_MULTIPATH_TCP_MPTCP_ = 30
...
E_ICMP_TYPE_NUMBER_RESERVED_FOR_SECURITY_ = 19
...
E_ICMP_TYPE_NUMBER_ICMP_MESSAGES_UTILIZED_BY_EXPERIMENTAL_MOBILITY_PROTOCOLS_SUCH_AS_SEAMOBY = 41
...
E_TYPE_NUMBER_APPLICATION_VND_WAP_MULTIPART_ = 34
...
E_TYPE_NUMBER_AUDIO_ = 79
E_TYPE_NUMBER_VIDEO_ = 80
...
E_SM_SERVICE_TYPE_VAS4SMS_SHORT_MESSAGE_VIRTUAL_PRIVATE_NETWORK_VPN_ = 7
...
E_MMTEL_SERVICE_TYPE_ORIGINATING_IDENTIFICATION_PRESENTATION_OIP_ = 0
E_MMTEL_SERVICE_TYPE_ORIGINATING_IDENTIFICATION_RESTRICTION_OIR_ = 1
E_MMTEL_SERVICE_TYPE_TERMINATING_IDENTIFICATION_PRESENTATION_TIP_ = 2
E_MMTEL_SERVICE_TYPE_TERMINATING_IDENTIFICATION_RESTRICTION_TIR_ = 3
E_MMTEL_SERVICE_TYPE_COMMUNICATION_HOLD_HOLD_ = 4
E_MMTEL_SERVICE_TYPE_COMMUNICATIONS_BARRING_CB_ = 5
E_MMTEL_SERVICE_TYPE_COMMUNICATION_DIVERSION_CDIV_ = 6
E_MMTEL_SERVICE_TYPE_COMMUNICATION_DIVERSION_NOTIFICATION_CDIVN_ = 7
E_MMTEL_SERVICE_TYPE_COMMUNICATION_WAITING_CW_ = 8
E_MMTEL_SERVICE_TYPE_MESSAGE_WAITING_INDICATION_MWI_ = 9
E_MMTEL_SERVICE_TYPE_CONFERENCE_CONF_ = 10
E_MMTEL_SERVICE_TYPE_FLEXIBLE_ALERTING_FA_ = 11
E_MMTEL_SERVICE_TYPE_COMPLETION_OF_COMMUNICATION_TO_BUSY_SUBSCRIBER_CCBS_ = 12
E_MMTEL_SERVICE_TYPE_COMPLETION_OF_COMMUNICATIONS_ON_NO_REPLY_CCNR_ = 13
E_MMTEL_SERVICE_TYPE_MALICIOUS_COMMUNICATION_IDENTIFICATION_MCID_ = 14
E_MMTEL_SERVICE_TYPE_CUSTOMIZED_ALERTING_TONE_CAT_ = 15
E_MMTEL_SERVICE_TYPE_CLOSED_USER_GROUP_CUG_ = 16
E_MMTEL_SERVICE_TYPE_PERSONAL_NETWORK_MANAGEMENT_PNM_ = 17
E_MMTEL_SERVICE_TYPE_CUSTOMIZED_RINGING_SIGNAL_CRS_ = 18
E_MMTEL_SERVICE_TYPE_ADVICE_OF_CHARGE_AOC_ = 19
...
E_SLG_LOCATION_TYPE_INITIAL_LOCATION_ = 2
...
E_VERTICAL_REQUESTED_VERTICAL_COORDINATE_IS_REQUESTED_ = 1
...
E_PERIODIC_LOCATION_SUPPORT_INDICATOR_NOT_SUPPORTED_ = 0
E_PERIODIC_LOCATION_SUPPORT_INDICATOR_SUPPORTED = 1
AVP_TGPP_PRIORITIZED_LIST_INDICATOR = 2551
E_PRIORITIZED_LIST_INDICATOR_NOT_PRIORITIZED_ = 0
...
AVP_TGPP_ISUP_RELEASE_CAUSE = 3416
...
AVP_TGPP_CELLULAR_NETWORK_INFORMATION_ = 3924
...
E_SPECIFIC_ACTION_SERVICE_INFORMATION_REQUEST_NOW_VOID_ = 0
...
E_SPECIFIC_ACTION_INDICATION_OF_ESTABLISHMENT_OF_BEARER_NOW_VOID_ = 5
...
E_APN_BARRING_TYPE_WLAN_APN_HOME_BARRED_WHEN_ROAMING_ = 1
...
E_SM_ENUMERATED_DELIVERY_FAILURE_CAUSE_UNKNOWN_SERVICE_CENTRE_ = 3
...
E_VODAFONE_REPORTING_REASON_FORCED_REAUTHORISATION_ = 7
...
E_VODAFONE_TRIGGER_TYPE_CHANGEINQOS_DELAY_CLASS_ = 12
...
E_SCAP_SUBSCRIPTION_ID_TYPE_END_USER_PRIVATE_OPERATOR_DEFINED_ = 4
...
E_SCAP_SERVICE_PARAMETER_TYPE_SERVICE_PROVIDER_ID_CCN_ = 0
E_SCAP_SERVICE_PARAMETER_TYPE_EXTENSION_NUMBER_1_CCN_ = 1
E_SCAP_SERVICE_PARAMETER_TYPE_EXTENSION_NUMBER_2_CCN_ = 2
E_SCAP_SERVICE_PARAMETER_TYPE_EXTENSION_NUMBER_3_CCN_ = 3
E_SCAP_SERVICE_PARAMETER_TYPE_EXTENSION_NUMBER_4_CCN_ = 4
E_SCAP_SERVICE_PARAMETER_TYPE_EXTENSION_TEXT_CCN_ = 5
E_SCAP_SERVICE_PARAMETER_TYPE_GPRS_QUALITY_OF_SERVICE_CCN_ = 6
E_SCAP_SERVICE_PARAMETER_TYPE_REDIRECTING_PARTY_NUMBER_CCN_ = 7
E_SCAP_SERVICE_PARAMETER_TYPE_ORIGINATING_LOCATION_INFORMATION_CCN_ = 8
E_SCAP_SERVICE_PARAMETER_TYPE_TERMINATING_LOCATION_INFORMATION_CCN_ = 9
E_SCAP_SERVICE_PARAMETER_TYPE_REGION_CHARGING_ORIGIN_CCN_ = 10
E_SCAP_SERVICE_PARAMETER_TYPE_SUBSCRIPTION_TYPE_CCN_ = 11
E_SCAP_SERVICE_PARAMETER_TYPE_SMS_DELIVERY_STATUS_CCN_ = 12
E_SCAP_SERVICE_PARAMETER_TYPE_TIME_ZONE_CCN_ = 13
E_SCAP_SERVICE_PARAMETER_TYPE_TRAFFIC_CASE_CCN_ = 14
E_SCAP_SERVICE_PARAMETER_TYPE_DEDICATED_ACCOUNT_ID_CCN_ = 15
E_SCAP_SERVICE_PARAMETER_TYPE_CALLING_PARTY_NUMBER_CCN_ = 16
E_SCAP_SERVICE_PARAMETER_TYPE_CALLED_PARTY_NUMBER_CCN_ = 17
E_SCAP_SERVICE_PARAMETER_TYPE_TELE_SERVICE_CODE_CCN_ = 18
E_SCAP_SERVICE_PARAMETER_TYPE_SERVICE_KEY_CCN_ = 19
AVP_ERICSSON_SCAP_SERVICE_PARAMETER_VALUE = 609
AVP_ERICSSON_SCAP_EVENT_TIMESTAMP = 610
AVP_ERICSSON_SCAP_UNIT_TYPE = 611
E_SCAP_UNIT_TYPE_SERVICE_CREDIT_TIME_SECONDS_ = 0
E_SCAP_UNIT_TYPE_SERVICE_CREDIT_VOLUME_BYTES_ = 1
E_SCAP_UNIT_TYPE_SERVICE_CREDIT_EVENTS_NUMBER_OF_EVENTS_ = 2
E_SCAP_UNIT_TYPE_SERIVCE_CREDIT_MONEY_MONETARY_VALUE_ = 3
...
E_INOVAR_APP_CODE__VIRTUAL_CALLER_ID_VCID_ = 2
...
E_FEE_TYPE_CHARGE_BY_MONTH_WITH_AUTHENTICATION_AND_FEE_DEDUCTION_ = 2
E_FEE_TYPE_CHARGE_BY_MONTH_WITH_AUTHENTICATION_BUT_NO_FEE_DEDUCTION_ = 3
E_FEE_TYPE_CHARGE_UPPER_LIMIT_AMOUNT_BY_THE_NUMBER_OF_SMS = 4
E_FEE_TYPE_CHARGE_BY_MONTH_WITH_LIMITED_NUMBER_OF_SMS_WITH_AUTHENTICATION_AND_FEE_DEDUCTION_ = 5
E_FEE_TYPE_CHARGE_BY_MONTH_WITH_LIMITED_NUMBER_OF_SMS_WITH_AUTHENTICATION_BUT_NO_FEE_DEDUCTION_ = 6
