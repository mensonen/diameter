...
E_SENSOR_MEASUREMENT_BAROMETRIC_PRESSURE = 0
E_SENSOR_MEASUREMENT_UE_SPEED = 1
E_SENSOR_MEASUREMENT_UE_ORIENTATION = 2
...
E_SF_PROVISIONAL_INDICATION_PROVISIONAL_ULR = 0
