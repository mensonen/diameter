...
This module contains Cancel Location Request and Answer messages,
...
__all__ = ["CancelLocation",
           "CancelLocationAnswer",
           "CancelLocationRequest"]


class CancelLocation(DefinedMessage):
    """An Cancel-Location base message.
    ...
    retrieved using the
    [CancelLocation.find_avps][diameter.message.Message.find_avps]
    search method.
    ...
    Examples:
        ...
        either an instance of `CancelLocationRequest` or
        `CancelLocationAnswer` automatically:

        >>> msg = Message.from_bytes(b"...")
        >>> assert msg.header.is_request is True
        >>> assert isinstance(msg, CancelLocationRequest)

        When creating a new message, the `CancelLocationRequest` or
        `CancelLocationAnswer` class should be instantiated directly,
    ...
    [CancelLocation.append_avp][diameter.message.Message.append_avp]
...
class CancelLocationAnswer(CancelLocation):
    """A Cancel-Location-Answer message.
...
class CancelLocationRequest(CancelLocation):
    """A Cancel-Location-Request message.
    ...
    avp_def: AvpGenType = (
        ...
        AvpGenDef("clr_flags", AVP_TGPP_CLR_FLAGS, VENDOR_TGPP),
        AvpGenDef("proxy_info", AVP_PROXY_INFO, type_class=ProxyInfo),
        AvpGenDef("route_record", AVP_ROUTE_RECORD),
    )
