...
class ProfileUpdate(DefinedMessage):
    ...
    retrieved using the
    [ProfileUpdate.find_avps][diameter.message.Message.find_avps]
    search method.
    ...
    Examples:
        ...
        either an instance of `ProfileUpdateRequest` or
        `ProfileUpdateAnswer` automatically:

        >>> msg = Message.from_bytes(b"...")
        >>> assert msg.header.is_request is True
        >>> assert isinstance(msg, ProfileUpdateRequest)

        When creating a new message, the `ProfileUpdateRequest` or
        `ProfileUpdateAnswer` class should be instantiated directly,
    ...
    [ProfileUpdate.append_avp][diameter.message.Message.append_avp]
