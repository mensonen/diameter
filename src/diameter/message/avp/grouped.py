...
@dataclasses.dataclass
class Load:
    """A data container that represents the "Load" (650) grouped AVP."""
    load_type: int = None
    load_value: int = None
    ...
    # noinspection PyDataclass
    avp_def: dataclasses.InitVar[AvpGenType] = (
        AvpGenDef("load_type", AVP_LOAD_TYPE, is_required=True),
        AvpGenDef("load_value", AVP_LOAD_VALUE, is_required=True),
        AvpGenDef("source_id", AVP_SOURCEID, is_required=True),
    )
