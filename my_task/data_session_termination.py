...
# APN (3GPP TS 32.299: Called-Station-Id AVP code 30 carries APN) [web:30]
APN = "eseyetest"
...
def _called_station_id_avp(apn: str) -> Avp:
    # Called-Station-Id is a base AVP (code 30). Some libraries expose it as constants.AVP_CALLED_STATION_ID.
...
def add_common_ccr_avps(ccr: CreditControlRequest):
    ...
    ps_info.value = [
        ...
        # APN in PS-Information as Called-Station-Id (AVP code 30) [web:30]
